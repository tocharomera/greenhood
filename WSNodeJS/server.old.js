...
const lstServicio = [
  ...
  { url: '/usuariosGreen', pk: 'email', fich: __dirname + '/data/usuariosGreen.json', readonly: false },
  { url: '/almacen', pk: 'id', fich: __dirname + '/data/almacen.json', readonly: false },
  { url: '/blog', pk: 'id', fich: __dirname + '/data/blog.json', readonly: false },
  { url: '/messages', pk: 'id', fich: __dirname + '/data/messages.json', readonly: false }
]
